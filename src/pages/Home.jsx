...
export default function Home() {
  ...
  const quickLinks = [
    ...
    { img: "/leetcode.png", title: 'LeetCode', link: 'https://leetcode.com/u/kunal_shaw04/' },
  ]
      ...
      <div className="home-top">
        ...
        >
          ...
          <p className="typing-effect">
            Artificial Intelligence & Machine Learning Engineer | Full Stack Developer 
          </p>
          ...
          <motion.div className="info-cards">
            {[
              { label: '📍 Location', value: 'Raichur, Karnataka, India' },
              { label: '💼 Expertise', value: 'AI/ML, Problem Solving' },
              { label: '📧 Contact', value: 'kunalshawkol17@gmail.com' },
            ].map((info, i) => (
