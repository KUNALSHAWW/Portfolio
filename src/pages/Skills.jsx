...
const ROWS = [
  [
    { title: "Programming Languages", items: ["Python", "C++", "Java", "JavaScript", "Kotlin", "SQL", "HTML", "CSS"] },
    { title: "Web & Backend", items: ["React", "Node.js", "FastAPI", "REST APIs", "Flask"] },
    { title: "Databases", items: ["MySQL", "PostgreSQL", "SQLite", "MongoDB", "FAISS", "ChromaDB"] },
    { title: "Tools & DevOps", items: ["Git/GitHub", "Docker", "AWS", "CI/CD", "Postman", "Jupyter Notebook"] },
  ],
  [
    {
